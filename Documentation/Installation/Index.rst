...
#. Get the extension
   ...
   #. **Get it from the Extension Manager:**
      ...
      *ns_all_lightbox* and import the extension from the repository.

   #. **Get it from typo3.org:** You can always get the current version from
      https://extensions.typo3.org/extension/ns_all_lightbox/ by downloading either
      the t3x or zip version. Upload the file afterwards in the Extension Manager.

   .. figure:: Images/TYPO3_All_In_One_Lightbx_Modalbox_Extension_NITSAN_Backend_install.png
...
#. Activate the TypoScript
   ...
   #. Select **[NITSAN] ns_all_lightbox** at the field *Include static
      (from extensions):*

   #. Include **[NITSAN] ns_all_lightbox** at the last place.

   .. figure:: Images/TYPO3_All_In_One_Lightbx_Modalbox_Extension_NITSAN_Backend_Include_Static_Template-min.png
       :alt: installation
